...
public class Runner {
    ...
    public Runner() { this.configFileName = "config.yml"; }

    public Parser main() {
        try {
            // Parse the given YAML configuration file using the com.Parser.com.Parser class definition
            Parser configData = new Yaml(new Constructor(Parser.class)).load(new FileInputStream("/APRFramework/" + configFileName));
